...
exports.synchronize = function(book,subtitle,updater,callback){
	...
	var doneWriting = function(){
		...
		if (nrdone === 2){
			...
			var child = spawn('java',['-jar','-Xmx4g','SemanticNetSimilarity.jar','book','subtitle',''+mindelta,''+minnumberofmatchingwords,''+relsearchwindow,''+minwordsim,''+relativelexicalimportance],
			{
